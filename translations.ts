...
export const translations = {
  en: {
    ...
    hero: {
      seasonMsg: 'Winter Season Registration Open',
    ...
    schedule: {
      ...
      tbdMessage: 'The Winter season schedule is currently being finalized.',
    ...
    register: {
      ...
      subtitle: 'Join the Winter season. Spots are limited.',
      seasonStart: 'Season starts September 7th',
      signupDeadline: 'Signup deadline: August 8th',
      pricingTitle: 'Registration Fee',
      pricingSubtitle: 'Transparent pricing with a community mission.',
      formTitle: 'Registration Form',
      earlyBird: 'Flat Rate',
      regularRate: 'Total Rate',
      perTeam: 'per team',
      endsOn: 'Starts on',
      deadline: 'Season starts',
      paymentPlan: 'Payment Policy',
      installment1: 'Payment must be made in full.',
      installment2: 'No payment installment plans are available.',
      ...
      includedFeatures: [
        ...
        'Arena: Centre Sportif de Delson'
      ],
      teamName: 'Team Name',
  ...
  fr: {
    ...
    hero: {
      seasonMsg: 'Inscriptions Saison d\'Hiver Ouvertes',
    ...
    schedule: {
      ...
      tbdMessage: 'Le calendrier de la saison d\'hiver est en cours de finalisation.',
    ...
    register: {
      ...
      subtitle: 'Rejoignez la saison d\'hiver. Places limitées.',
      seasonStart: 'La saison débute le 7 septembre',
      signupDeadline: 'Date limite d\'inscription : 8 août',
      ...
      earlyBird: 'Tarif Fixe',
      regularRate: 'Tarif Total',
      perTeam: 'par équipe',
      endsOn: 'Débute le',
      deadline: 'Début de la saison',
      paymentPlan: 'Politique de paiement',
      installment1: 'Le paiement doit être effectué en totalité.',
      installment2: 'Aucun plan de versement de paiement n\'est disponible.',
      whatsIncluded: 'Ce qui est inclus ?',
      includedFeatures: [
        'Minimum de 30 matchs garantis',
        'Avantages partenaires',
        'Arbitrage professionnel',
        'Statistiques et résumés de matchs numériques',
        'Aréna : Centre Sportif de Delson'
      ],
