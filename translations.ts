...
export const translations = {
  en: {
    ...
    hero: {
      ...
      recHockey: 'of Hockey',
      description: "Join the premier recreational league that prioritizes safety, affordability, and community-driven play.",
  ...
  fr: {
    ...
    hero: {
      ...
      recHockey: 'du Hockey',
      description: "Rejoignez la ligue récréative de premier plan qui priorise la sécurité, l'accessibilité et le jeu communautaire.",
