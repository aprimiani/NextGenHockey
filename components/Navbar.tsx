        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center">
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              <NavLink
                to="/register"
                className="bg-ng-light-blue hover:bg-ng-accent text-ng-navy font-bold py-2 px-4 rounded-md transition-colors shadow-lg shadow-ng-light-blue/30 ml-2 font-display uppercase tracking-widest"
              >
                {t.nav.register}
              </NavLink>
            </div>
          ...
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            {navItems.map((item) => (
             ...
             <NavLink
                to="/register"
                onClick={() => setIsOpen(false)}
                className="block w-full text-center mt-4 bg-ng-light-blue hover:bg-ng-accent text-ng-navy font-bold py-3 px-4 rounded-md font-display uppercase tracking-widest text-lg"
              >
                {t.nav.register}
              </NavLink>
          </div>
