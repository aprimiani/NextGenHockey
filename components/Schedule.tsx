                ...
                <div>
                    ...
                    <div className="overflow-x-auto">
                        <table className="min-w-full divide-y divide-gray-700">
                            <thead><tr><th className="px-4 py-2 text-left text-xs font-medium text-gray-400 uppercase">{t.schedule.team}</th><th className="px-4 py-2 text-left text-xs font-medium text-gray-400 uppercase">Goalie</th><th className="px-4 py-2 text-center text-xs font-medium text-gray-400 uppercase">Shots</th><th className="px-4 py-2 text-center text-xs font-medium text-gray-400 uppercase">Saves</th></tr></thead>
                            <tbody className="divide-y divide-gray-700">
                                <tr><td className="px-4 py-3 text-sm text-gray-300">{getTeamName(game.homeTeamId)}</td><td className="px-4 py-3 text-sm font-bold text-white">{selectedRecap.goalieStats.homeGoalie.name}</td><td className="px-4 py-3 text-sm text-center text-gray-300">{selectedRecap.goalieStats.homeGoalie.shotsFaced}</td><td className="px-4 py-3 text-sm text-center text-gray-300">{selectedRecap.goalieStats.homeGoalie.saves}</td></tr>
